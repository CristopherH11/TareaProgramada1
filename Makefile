all:
	...
	g++ -g -o bin/envios bin/tipoEnvio.o bin/enviosPostal.o bin/enviosFedEx.o bin/arregloEnvios.o bin/main.o
...
test:
	...
	g++ -g -o bin/tests bin/tests_enviosFedEx_calculodeCosto.o bin/tests_enviosPostal_calculodeCosto.o bin/tests_arregloEnvios.o bin/main.o bin/tipoEnvio.o bin/enviosFedEx.o bin/enviosPostal.o bin/arregloEnvios.o -lgtest -lgtest_main -lpthread
