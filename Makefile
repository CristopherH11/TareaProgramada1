...
test:
	...
	g++ -g -o bin/tests bin/tests_enviosFedEx_calculodeCosto.o bin/tipoEnvio.o bin/enviosFedEx.o bin/enviosPostal.o bin/arregloEnvios.o -lgtest -lgtest_main -lpthread
